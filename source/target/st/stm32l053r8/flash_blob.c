...
static const uint32_t STM32L053R8_flash_prog_blob[] = {
...
static const program_target_t flash = {
    ...
    sizeof(STM32L053R8_flash_prog_blob),   // prog_blob size
    STM32L053R8_flash_prog_blob,           // address of prog_blob
