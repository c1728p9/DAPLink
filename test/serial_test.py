...
class SerialTester(object):
    ...
    def __init__(self, port):
        ...
        self._sp.write_timeout = ERROR_TIMEOUT_SECONDS
        self._baud = 115200
    ...
    def new_session_with_baud(self, baud, parent_test):
        ...
        # Set baud to 115200
        self._baud = 115200
        self._sp.baudrate = self._baud
        self._sp.timeout = 1.0
        ...
        # Set default timeout
        self._sp.timeout = ERROR_TIMEOUT_SECONDS
